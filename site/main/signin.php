...
<body class="center-block">
    ...
    if ($loginError or $registerError) {
        echo '<div class="alert alert-danger col-auto" role="alert" style="text-align: center">';
        echo $message;
        echo '</div>';
    }elseif ($result){
        echo '<div class="alert alert-info col-auto" role="alert" style="text-align: center">';
        echo $message;
        echo '</div>';
    }
    ?>
    <div id="formswitch" class="panel-group">
        ...
        <div id="loginForm" class="collapse show" aria-labelledby="loginOpener" data-parent="#formswitch">
            <div class="card card-body">
                <form class="form-inline form-center" action="?login=1" method="post">
